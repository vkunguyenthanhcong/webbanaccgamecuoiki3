...
<html lang="en">
	...
	<body>
		...
		<section style="margin-top: 50px; " class="container">
			<H3>ACC LIÊN MINH HUYỀN THOẠI SIÊU VIP, GIÁ RẺ, AN TOÀN, UY TÍN 100%</H3>
			<div style="border-radius: 5px; background-color: #cceeff; padding: 10px; margin-bottom: 50px;">
				<p style="font-size: 20px;"><b style="color: rgb(230, 76, 76)">Hot : </b><b>Nhận tìm skin theo yêu cầu của anh chị em.</b></p>
				<p style="font-size: 20px;"><b style="color: rgb(76, 230, 76)">Acc Liên Minh Siêu VIP Giá Rẻ</b></p>
				<p style="font-size: 20px;"><b>Acc Liên Minh Giá Rẻ, CÁC BẠN KHI MUA ACC VỀ HÃY ĐỔI MẬT KHẨU HOẶC THÊM SỐ ĐIỆN THOẠI VÀO NHÉ!! TRUY CẬP WEBSITE : <u>https://account.garena.com/</u> ĐỂ ĐỔI THÔNG TIN TÀI KHOẢN.</b></p>
			</div>
			<div class="main">
			<div class="col-md-10" style="margin-bottom: 50px">
					...
					<button class="btn btn-success" type="submit" id="timkiem" name="timkiem"> Tìm kiếm </button>
					
			</div>
				<?php
				require_once 'lib/connection.php';
						$lm = mysqli_query($conn, "SELECT * FROM acc WHERE game = 'lmht' and damua = 'false'");
				?>
				<div id="xemthongtin">
				<?php while ($row = mysqli_fetch_array($lm)){ ?>
	...
	$(document).ready(function(){
		$("#timkiem").click(function(event){
			...
			$.ajax({
			    type: "POST",
			    url: "timkiemacc.php?game=lmht&&tien=" + giatimkiem,
