...
<html lang="en">
	...
	<body>
		...
		<section style="margin-top: 50px; " class="container">
			...
			<H3>ACC LIÊN QUÂN SIÊU VIP, GIÁ RẺ, AN TOÀN, UY TÍN 100%</H3>
			<div style="border-radius: 5px; background-color: #cceeff; padding: 10px; margin-bottom: 50px;">
				...
				<p style="font-size: 20px;"><b style="color: rgb(76, 230, 76)">Acc Liên Quân Siêu VIP Giá Rẻ</b></p>
				<p style="font-size: 20px;"><b>Acc Liên Quân Giá Rẻ, CÁC BẠN KHI MUA ACC VỀ HÃY ĐỔI MẬT KHẨU HOẶC THÊM SỐ ĐIỆN THOẠI VÀO NHÉ!! TRUY CẬP WEBSITE : <u>https://account.garena.com/</u> ĐỂ ĐỔI THÔNG TIN TÀI KHOẢN.</b></p>
			</div>
			<div class="main">
			...
			<div class="col-md-10" style="margin-bottom: 50px">
				...
				require_once 'lib/connection.php';
				    $lq = mysqli_query($conn, "SELECT * FROM acc WHERE game = 'lienquan' and damua = 'false'");
				?>
				<div id="xemthongtin">
				<?php while ($row = mysqli_fetch_array($lq)){ ?>
	...
	$(document).ready(function(){
		$("#timkiem").click(function(event){
			...
			$.ajax({
			    type: "POST",
			    url: "timkiemacc.php?game=lienquan&&tien=" + giatimkiem,
