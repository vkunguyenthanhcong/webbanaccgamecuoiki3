...
$q = mysqli_query($conn, "SELECT * FROM acc WHERE game = 'lmht'");
?>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title">Danh sách Acc Liên Minh Huyền Thoại</h3>
                                ...
                                <table class="table text-nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-top-0">Tướng</th>
                                            <th class="border-top-0">Skin</th>
                                            <th class="border-top-0">Rank</th>
                                            <th class="border-top-0">Tình trạng</th>
                                            <th class="border-top-0">Linh thú</th>
